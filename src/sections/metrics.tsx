...
const Metrics: React.FC = ()=>{
    return(<div className="metrics flex gap-5 justify-end items-center px-20">
        {data.map((e,idx)=>(<div key={`Metrics_${e.hint}_${idx}`} className="card-metrics justify-center p-4 flex flex-col justify-center items-center text-center gap-1" >
