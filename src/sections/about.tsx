...
const About = () => {
    return (<div id="about" className="px-20 py-10 items-center flex flex-col gap-10">
        ...
        <div className="grid grid-cols-3 gap-5">
            {aboutData.first_section.map((e,idx)=><div key={`About_${e.title}_${idx}`} className="card-hero card-about p-5 pr-20 flex flex-col gap-2">
